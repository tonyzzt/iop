...
public:
	...
	u_int32_t sumanddel (timeval t, u_int32_t * packets);
...
public:
	...
	void sumanddel(timeval curtime, u_int32_t * recv, u_int32_t * sent, u_int32_t * packet_recv, u_int32_t * packet_sent);
	...
	/* total sum or sent/received packets */
	u_int32_t sumPacketSent;
	u_int32_t sumPacketRecv;
